...
/* =========================
   ...
   Book III has no intro video screen like Book I's
   character.html, so nothing else removes the
   "display:none" that .character-screen starts with
   in character3.css. Show it immediately on load.
========================= */
        ...
        card.addEventListener(
            ...
            function(){
                ...
                /* =========================
                   ...
                   is the shared key book3.js reads from
                   (same key used by book1.js / book2.js).
                ========================= */
